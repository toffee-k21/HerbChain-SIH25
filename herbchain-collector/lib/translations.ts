...
export const translations = {
  en: {
    ...
    'dashboard.searchPlaceholder': 'Search herbs, collections...',
    'dashboard.recordCollection': 'Record',
    'dashboard.recordDescription': 'Document your herb collection',
    'dashboard.myWallet': 'My Earnings',
    'dashboard.walletDescription': 'Manage your blockchain wallet',
    'dashboard.qualityHerbs': 'Quality Herbs',
    'dashboard.authenticSources': 'Authentic Sources',
    'dashboard.verifiedCollections': 'Verified Collections',
    'dashboard.helpCenter': 'Help Center',
    'dashboard.kheytiKiBaat': 'Kheyti Ki Baat',
    'dashboard.nearHotspots': 'Near Hotspots',
  ...
  hi: {
    ...
    'dashboard.searchPlaceholder': 'जड़ी-बूटियों, संग्रह खोजें...',
    'dashboard.recordCollection': 'संग्रह रिकॉर्ड करें',
    'dashboard.recordDescription': 'अपनी जड़ी-बूटी संग्रह का दस्तावेज़ीकरण करें',
    'dashboard.myWallet': 'मेरा वॉलेट',
    'dashboard.walletDescription': 'अपना ब्लॉकचेन वॉलेट प्रबंधित करें',
    'dashboard.qualityHerbs': 'गुणवत्ता वाली जड़ी-बूटियां',
    'dashboard.authenticSources': 'प्रामाणिक स्रोत',
    'dashboard.verifiedCollections': 'सत्यापित संग्रह',
    'dashboard.helpCenter': 'सहायता केंद्र',
    'dashboard.kheytiKiBaat': 'Kheyti Ki Baat',
    'dashboard.nearHotspots': 'नजदीकी हॉटस्पॉट',
    'dashboard.procurement': 'खरीदारी',
